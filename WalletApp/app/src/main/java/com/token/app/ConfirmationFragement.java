        ...
        this.handler = new Handler() {
            public void handleMessage(Message message) {
                if (!message.obj.toString().equalsIgnoreCase("true")) {
                    ...
                    ConfirmationFragement.this.account_txt.setText(new StringBuilder(String.valueOf(ConfirmationFragement.this.global.getAccountbalance())).append(" BD").toString());
                }
            }
        };
    }
