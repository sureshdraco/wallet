...
public class BalanceActivity extends Activity implements OnClickListener {
    ...
    public BalanceActivity() {
        ...
        this.authenticateRunnable = new Runnable() {
            public void run() {
                try {
                    BalanceActivity.this.res_mString = WebServiceHandler.buyAuthenticateService(BalanceActivity.this, BalanceActivity.this.email_mString, BalanceActivity.this.password_mString);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                Message message = new Message();
        ...
        this.buycreditRunnable = new Runnable() {
            public void run() {
                try {
                    ...
                    BalanceActivity.this.res_mString = WebServiceHandler.buycreditService(BalanceActivity.this, authenticateid_gString, BalanceActivity.this.amount_mString, "1", "debitcard");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                Message message = new Message();
