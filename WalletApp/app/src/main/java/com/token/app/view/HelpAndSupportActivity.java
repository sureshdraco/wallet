...
public class HelpAndSupportActivity extends Activity implements OnClickListener {
        ...
        this.handler = new Handler() {
            public void handleMessage(Message message) {
                ...
                if (message.obj.toString().equalsIgnoreCase("true")) {
                    Crouton.showText(HelpAndSupportActivity.this, "Withdrawal Done Successfully!!", Style.ALERT);
                } else {
                    Crouton.showText(HelpAndSupportActivity.this, "Error Occured due to some server problem!!", Style.ALERT);
                }
            }
        };
    ...
    /* renamed from: com.token.app.view.HelpAndSupportActivity.6 */
