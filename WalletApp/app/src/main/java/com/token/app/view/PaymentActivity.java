		...
		this.accountRunnable = new Runnable() {
			public void run() {
				try {
					...
					String pwd = PaymentActivity.this.sp.getString(GlobalConstants.PREF_PASSWORD, "");
					PaymentActivity.this.res = WebServiceHandler.accountBalanceservice(PaymentActivity.this, string, pwd);
				} catch (Exception e) {
					e.printStackTrace();
				}
