    ...
    public ReceiveMoneyFragment() {
        ...
        this.tokenhandler = new Handler() {
            public void handleMessage(Message message) {
                ...
                ((InputMethodManager) ReceiveMoneyFragment.this.getActivity().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(ReceiveMoneyFragment.this.getActivity().getCurrentFocus().getWindowToken(), 2);
