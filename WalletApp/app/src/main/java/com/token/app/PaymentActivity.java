		...
		this.handler = new Handler() {
			public void handleMessage(Message message) {
				...
				if (!message.obj.toString().equalsIgnoreCase("true")) {
					Toast.makeText(PaymentActivity.this, "Error Occured due to some server problem!!", Toast.LENGTH_LONG).show();
				} else if (PaymentActivity.this.global.getAccountbalance().equalsIgnoreCase("")) {
					PaymentActivity.this.account_txt.setText("0 BD");
					Toast.makeText(PaymentActivity.this, "You don't have account balance", Toast.LENGTH_LONG).show();
				} else {
